...
function page() {
  return (
    <main className='flex flex-col w-full font-league-spartan '>
      ...
      <div className='bg-gray-50 text-black flex flex-col md:flex-row justify-center gap-3 p-12 w-screen md:px-20'>
      <div className=' md:flex md:w-1/2 md:max-h-screen items-center '>
      <FormLeftSide/>
      </div>


      <div className='bg-white md:w-1/2 flex flex-col  justify-center md:my-12  py-10 px-2 shadow rounded-2xl hover:shadow-2xl  transition-all duration-300'>
        <FormRightSide/>
