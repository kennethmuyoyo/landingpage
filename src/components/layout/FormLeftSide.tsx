...
function FormLeftSide() {
  return (
    <div className='flex flex-col gap-2 '>
        <h1 className=" my-4 font-league-spartan-bold text-4xl md:text-6xl text-black font-bold leading-tight text-center md:text-left slide-in-bottom-h1">Let us help you in your spiritual journey</h1>
